...
async function updateParty(partyId, resource) {
  ...
  updatePartyDrinkList(resource, partyCollection, objectId);
  return modifiedCount;
}

async function removePartyIngredient(partyId, resource) {
  const partyCollection = await getCollection('parties');
  const objectId = new ObjectID.createFromHexString(partyId);
...
async function updatePartyDrinkList(resource, partyCollection, objectId) {
...
exports.removePartyIngredient = removePartyIngredient;
